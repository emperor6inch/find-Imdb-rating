...
# For eg; "/Users/emperor6inch/Desktop/IMDB_films"
path = input("Enter the path where your films are present:")
...
for line in films:
    ...
    try:
        ...
        #getting contact from IMDB Website
        content = response.content

        # print(response.status_code)

        soup = BeautifulSoup(response.content, features= "html.parser")
        #searching for all films containers found
        ...
        if title in name:
            #scraping rating
            rating = result.find("div", class_="inline-block ratings-imdb-rating").text
            #scraping genres
...
df.to_csv("IMDB_ratings.csv", index=False, encoding='utf-8')
